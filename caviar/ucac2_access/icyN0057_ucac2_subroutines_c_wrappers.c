...
typedef struct {                /* Define string descriptor */
  int slen;          /* Length of string, 0 for null */
...
*/
//STRING idl_string;
//idl_string = (STRING) *argv[0];
//printf("debug from C wrapper: string fields are slen: [%d] stype: [%d] s: [%s]\n",
//1,2,"test");
//	idl_string.slen, idl_string.stype, idl_string.s);
printf("debug from C wrapper: pathu is at [%ld], temp1 is [%s]\n", pathu, temp1);
