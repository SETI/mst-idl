...
if (gap eq 'H' or gap eq 'h') then begin
    savefile = filestem+'.edgeH'
    dumpfile = filestem+'.edge_linsamH'
endif

if (gap eq 'U' or gap eq 'u') then begin
    savefile = filestem+'.edgeU'
    dumpfile = filestem+'.edge_linsamU'
endif

if (gap eq 'S' or gap eq 's') then begin
    savefile = filestem+'.edgeS'
    dumpfile = filestem+'.edge_linsamS'
endif

if (gap eq 'J' or gap eq 'j') then begin
    savefile = filestem+'.edgeJ'
    dumpfile = filestem+'.edge_linsamJ'
endif
