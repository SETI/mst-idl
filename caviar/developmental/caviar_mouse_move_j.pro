	...
	pro caviar_mouse_move_j,im,symbol,symbol_size,stars,planet,ring,cmat,vobs,$
	...
	get_planet_name_j,planet[*,0],plan_names
	@plot_planets
	...
	while (!mouse.button eq 1 ) do begin
		...
		image_coords_j,stars,cmat,vobs,pixscale,nl,coords
		image_coords_j,planet,cmat,vobs_planet,pixscale,nl,planet_coords
		image_coords_j,ring,cmat,vobs_planet,pixscale,nl,ring_coords
