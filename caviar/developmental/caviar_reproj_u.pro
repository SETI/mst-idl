	...
	pro caviar_reproj_u,polera,poledec,planet_id,im,rawim,et,$
                   cmat,ri,ro,lon_start,lon_stop,pixscale,nl,rpi_l,rpi_s,zf,$
	...
	for i=0,round(rpi_l)-1 do begin
		...
		get_ring,et,r_radius[i],lon_start,lon_stop,polera,poledec,round(rpi_s),ring,799L,-32L, light_time=light_time

		image_coords_u,ring,cmat,[0.0d0,0.0d0,0.0d0],pixscale,nl,coords
