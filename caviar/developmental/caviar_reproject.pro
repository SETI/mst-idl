pro caviar_reproject,im,rawim,mnrad,mxrad,mnlon,mxlon,et,polera,$
poledec,cam_params,nl,cmat,vobs_planet,ry,rx,rzoom,resfac,forcexy=forcexy,$
...
get_ring,et,[rpj_mnrad,rpj_mxrad],mnlon,mxlon,polera,poledec,nnn,reproj_region,699L, light_time=light_time
...
caviar_reproj,polera,poledec,699L,im,rawim,et,cmat,rpj_mnrad,rpj_mxrad,mnlon,mxlon,cam_params,nl,$
ry,rx,rzoom, $
