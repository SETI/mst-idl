...
if not keyword_set(silent) then print, 'Radius range:                    '+string(keywords.ringplane_minimum_radius,fo=fo1)+' to '+string(keywords.ringplane_maximum_radius,fo=fo2)+' km'
...
if not keyword_set(silent) then print, 'Aimpoint radius and longitude:   '+string(keywords.ringplane_aimpoint_radius,fo=fo3)+' km, '+strtrim(keywords.ringplane_aimpoint_longitude,2)+' degrees'
