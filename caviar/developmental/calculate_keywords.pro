...
; centered on Saturn.
cspice_spkez,10L,et,'J2000','CN+S',699L,state,ltime
...
keywords = { $
            ...
            ringplane_aimpoint_radial_scale: v_mag(camera_coord-aimpoint_coord)^2 * cam_params[11]*summ*2 / v_mag(v_cross(camera_coord-aimpoint_coord,planet_coord-aimpoint_coord)) * v_mag(planet_coord-aimpoint_coord), $
            ringplane_aimpoint_longitudinal_scale_km: v_mag(camera_coord-aimpoint_coord)^2 * cam_params[11]*summ*2 / v_mag(v_cross(camera_coord-aimpoint_coord,v_cross(vertical,planet_coord-aimpoint_coord))) * v_mag(planet_coord-aimpoint_coord), $
            ringplane_aimpoint_longitudinal_scale_deg: v_mag(camera_coord-aimpoint_coord)^2 * cam_params[11]*summ*2 / v_mag(v_cross(camera_coord-aimpoint_coord,v_cross(vertical,planet_coord-aimpoint_coord))) * v_mag(planet_coord-aimpoint_coord) / aimp_radius * 180 / !dpi, $
