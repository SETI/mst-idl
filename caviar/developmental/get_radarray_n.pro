pro get_radarray_n, pixscale, cmat, nl, et, polera, poledec, sc, radarray, lonarray, outofplane=outofplane, nointerp=nointerp, minmaxonly=minmaxonly, planet_coords=planet_coords
...
p2ralon_quicker_n, cmat, et, polera, poledec, sc, RA, dec, rad, lon, $
