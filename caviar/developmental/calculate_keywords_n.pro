...
p2ralon_n,cmat,et,polera,poledec,sc,aimp_ra,aimp_dec,aimp_radius,aimp_lon &$
endelse
get_ring,et,aimp_radius,0,0,polera,poledec,1,0,8L,-32L,lons=aimp_lon,j2000_xyz=aimpoint_coord
