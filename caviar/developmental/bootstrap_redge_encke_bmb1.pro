;;This is an archaic version of bootstrap. Use
;;boostrap_redge_encke_bmb3 instead.
...
dl=0
;;;dt=0
dt0=0.0     ; Previous EI arrays time offset
dt1=0.0     ; Current EI array time offset
dt2=0.0     ; Previous EO arrays time offset
dt3=0.0     ; Current EO array time offset
dt4=0.0     ; Previous KI arrays time offset
dt5=0.0     ; Current KI array time offset
dt6=0.0     ; Previous KO arrays time offset
dt7=0.0     ; Current KO array time offset
dt8=0.0     ; Previous R arrays time offset
dt9=0.0     ; Current R array time offset
