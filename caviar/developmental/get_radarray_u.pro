pro get_radarray_u, pixscale, cmat, nl, et, polera, poledec, sc, radarray, lonarray, outofplane=outofplane, nointerp=nointerp, minmaxonly=minmaxonly, planet_coords=planet_coords
...
endelse
p2radec_quicker_u, pixscale, cmat, nl, yarray, xarray, ra, dec
p2ralon_quicker_u, cmat, et, polera, poledec, sc, RA, dec, rad, lon, $
