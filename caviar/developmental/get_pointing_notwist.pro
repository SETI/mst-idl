	...
	pro get_pointing_notwist,rac,decc,twistc,located_stars,vobs,cam_params,cmat,nl,debug=debug,minimum_rms=minimum_rms,num_stars=num
	...
	image_coords,located_stars[*,0:2],cmat,vobs,cam_params,nl,coords
