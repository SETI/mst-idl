	...
	pro caviar_reproj_j,polera,poledec,planet_id,im,rawim,et,$
	...
	for i=0,round(rpi_l)-1 do begin
		...
		get_ring,et,r_radius[i],lon_start,lon_stop,polera,poledec,round(rpi_s),ring,599L,-98L, light_time=light_time

		image_coords_j,ring,cmat,[0.0d0,0.0d0,0.0d0],pixscale,nl,coords
