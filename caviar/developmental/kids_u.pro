pro kids_u,et,cmat,pixscale,nl,sc,polera,poledec,im,vobs_planet,radius_inner,$
...
1:	begin
	...
	p2ralon_u,cmat,et,polera,poledec,sc,RA,dec,radius_1,lon_1

	get_ring,et,[radius_1],0.0,360.0,polera,poledec,3600,temp_reproj_region_i,799L,-32L
	get_ring,et,[60000,5.0d0*radius_1],lon_1,lon_1,polera,poledec,1,sline_far_end,799L, -32L
...
1:	begin
	...
	p2radec_quicker_u,pixscale,cmat,nl,line,sample,RA,dec
	p2ralon_u,cmat,et,polera,poledec,sc,RA,dec,radius_2,lon_2
...
donewithmouse:
	...
	get_ring,et,[radius_1,radius_2],lon_1,lon_2,polera,poledec,3600,reproj_region,799L,-32L
