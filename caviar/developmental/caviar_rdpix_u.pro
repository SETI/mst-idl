...
Pro caviar_rdpix_u,Image,pixscale,cmat,nl,et,polera,poledec,sc,X0,Y0,x=x,y=yy,q=q,radec=radec,cray=cray
...
if keyword_set(cray) then cray=1 else cray=0
while !mouse.button ne 4 do begin
	CURSOR,x,y,2+cray,/dev
	...
	if (!mouse.button and 3) ne 0 then begin	;New line?
	   p2radec_quicker_u,pixscale,cmat,nl,y,x,RA,dec
