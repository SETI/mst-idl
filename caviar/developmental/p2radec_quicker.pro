...
pro p2radec_quicker,cam_params,cmat,nl,line,sample,RA,dec
...
x0 = (sample-boresight[0]) * summ / cam_params[4]
y0 = (line-boresight[1]) * summ / cam_params[7]
...
rho[*,0] = x / cam_params[0]
rho[*,1] = y / cam_params[0]
rho[*,2] = 1.0d0
...
if n_elements(tcmat) eq 9 then d_rho_J2000=tcmat##rho else begin
  d_rho_j2000 = dblarr(nn,3)
  for j=0,nn-1 do begin
    d_rho_j2000[j,*] = reform(tcmat[j,*,*]) ## rho[j,*]
  endfor 
endelse
