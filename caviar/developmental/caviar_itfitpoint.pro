	pro caviar_itfitpoint,rastart,decstart,twiststart,located_stars,vobs,cam_params,tol,rao,deco,twisto,cmat,nl,notwist=notwist,debug=debug,minimum_rms=minimum_rms,num_stars=num_stars
	...
	print,' '
	  ...
	  get_pointing_notwist,rac,decc,twistc,located_stars,vobs,cam_params,cmat,nl,debug=debug,minimum_rms=minimum_rms,num_stars=num_stars
        endif else begin
