...
;=============================================================================
;+
; $Id: write_vicar.pro,v 1.1 2008/08/27 18:04:32 nathan Exp $
; write_vicar
;
; PURPOSE
;`
...
;----------------------determine host------------------------
 ...
 host=gethost(status=status,silent=silent)
