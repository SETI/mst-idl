pro get_radarray_j, pixscale, cmat, nl, et, polera, poledec, sc, radarray, lonarray, outofplane=outofplane, nointerp=nointerp, minmaxonly=minmaxonly, planet_coords=planet_coords
...
endelse
p2radec_quicker_j, pixscale, cmat, nl, yarray, xarray, ra, dec
p2ralon_quicker_j, cmat, et, polera, poledec, sc, RA, dec, rad, lon, $
