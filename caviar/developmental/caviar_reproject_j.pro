pro caviar_reproject_j,im,rawim,mnrad,mxrad,mnlon,mxlon,et,polera,$
...
if not keyword_set(noradarray) then get_radarray_j, pixscale, cmat, nl, et, $
   polera, poledec, -98l, radarray, lonarray, outofplane=outofplane, $
...
get_ring,et,[rpj_mnrad,rpj_mxrad],mnlon,mxlon,polera,poledec,nnn,reproj_region,599L,-98L, light_time=light_time
image_coords_j,reproj_region,cmat,vobs_planet,pixscale,nl,reproj_region_coords
...
caviar_reproj_j,polera,poledec,599L,im,rawim,et,cmat,rpj_mnrad,rpj_mxrad,mnlon,mxlon,pixscale,nl,$
ry,rx,rzoom, $
