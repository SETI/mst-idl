pro plot_fft, y, power, f, xlog=xlog, ylog=ylog, base2=base2, xunits=xunits, xtit=xtit, ytit=ytit, tit=tit, ps=ps, xr=xr, yr=yr, coeff=coeff, nosignif=nosignif, xx=xx, yy=yy, oplot=oplot, color=color, no95=no95, plotf=plotf, xtickn=_xtn, xma=_xma, yma=_yma, noplot=noplot, nonorm=nonorm
...
lambda = 1./f
coeff = n/2/variance
if keyword_set(nonorm) then yy = power else yy = power*coeff
