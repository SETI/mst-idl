...
;   for normalized associated Legendre polynomials.  They should be
;   stable (and avoid underflow) for evaluations of high order
;   expansions.
;
; EXAMPLE:
...
;
;  $Id: geograv.pro,v 1.4 2004/11/19 14:58:58 craigm Exp $
;
;-
